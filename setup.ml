...
(* OASIS_START *)
(* DO NOT EDIT (digest: 34c4462015c7d89bdd4c8344be737d1f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/xguerin/netml";
          bugreports = None;
          synopsis = "Network packets parsing and authoring";
          description =
            Some [OASISText.Para "Network packets parsing and authoring"];
          tags = [];
          categories = [];
          files_ab = ["META.ab"];
          sections =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xguerin/netml.git";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_bitstring", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tools/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "netml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "pcap_parser.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "!\164\1442\135\167\242b\144}\146\249\171\030\n\161";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
